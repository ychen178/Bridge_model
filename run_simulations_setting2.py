...
# implements Bridge and Bridge Naive version 
# compare columns in the excel file for the RMSEs across 4 methods
...
excel_tab = "setting2_n1k5b_ol0d2"
...
n_factor = 5
center_prop = [0.5, 0.5]
gene_prop = np.array([[0,0.7], [0.5, 1]])  # also tried 
px = len(center_prop)
n_contV = 1; 
n_binaryV = 1; 
